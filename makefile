...
system:
	...
	cp ./workspace/all/minarch/build/$(PLATFORM)/liblz4.so.1 ./build/SYSTEM/$(PLATFORM)/lib/
	cp ./workspace/all/minarch/build/$(PLATFORM)/libsamplerate.so.0 ./build/SYSTEM/$(PLATFORM)/lib/
